...
describe("groupBySession", () => {
  it("sessionId ごとに出現順を保って振り分ける", () => {
    const events: AppEvent[] = [
      { kind: "taskStarted", sessionId: "s1", agentId: "a", startedAt: "t0", prompt: "依頼", model: null },
      { kind: "taskStarted", sessionId: "s2", agentId: "b", startedAt: "t0", prompt: "依頼", model: null },
...
describe("sessionSummary", () => {
  it("taskStarted のみなら running", () => {
    const events: AppEvent[] = [{ kind: "taskStarted", sessionId: "s1", agentId: "survey-analyst", startedAt: "t0", prompt: "依頼", model: null }];
