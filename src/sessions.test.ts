...
describe("groupBySession", () => {
  it("sessionId ごとに出現順を保って振り分ける", () => {
    const events: AppEvent[] = [
      { kind: "taskStarted", sessionId: "s1", agentId: "a", startedAt: "t0" },
      { kind: "taskStarted", sessionId: "s2", agentId: "b", startedAt: "t0" },
...
describe("sessionSummary", () => {
  it("taskStarted のみなら running", () => {
    const events: AppEvent[] = [{ kind: "taskStarted", sessionId: "s1", agentId: "survey-analyst", startedAt: "t0" }];
